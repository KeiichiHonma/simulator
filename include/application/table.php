...
class applicationTable extends tableManager
{
    static private $table_info = array
        (
            ...
            array('column'=>'mobile_images',     'as'=>'application_mobile_images', 'type'=>COMMON, 'input'=>TRUE,  'group'=>null),
            array('column'=>'console_images',    'as'=>'application_console_images','type'=>COMMON, 'input'=>TRUE,  'group'=>null),
