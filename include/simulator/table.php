...
class simulatorTable extends tableManager
{
    static private $table_info = array
        (
            ...
            array('column'=>'mobile_images',     'as'=>'simulator_mobile_images', 'type'=>COMMON, 'input'=>TRUE,  'group'=>null),
            array('column'=>'console_images',    'as'=>'simulator_console_images','type'=>COMMON, 'input'=>TRUE,  'group'=>null),
