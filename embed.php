...
print "} else {";
print "document.write(\"<link rel='stylesheet' href='http://\"+fqdn+\"/css/simulator.css' type='text/css' media='all' /><script type='text/javascript' src='http://\"+fqdn+\"/js/simulator.js'></script><div id='simulator'><iframe src='http://\"+fqdn+\"/iframe?uid=".$_GET['uid']."' style='z-index: 1;padding:0;margin:0;' scrolling='no' frameborder='0' width='240' height='579'></iframe></div>\");";
print "}";
?>
