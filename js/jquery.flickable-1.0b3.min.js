...
b=this;this.each(function(){var c=h.data(this,"flickable"),e=c&&h.isFunction(c[a])?c[a].apply(c,d):c;if(e!==c&&e!==q){b=e;return false}});return b}else return this.each(function(){var c=h.data(this,"flickable");if(c){h.extend(true,c.options,a);c.init()}else h.data(this,"flickable",new s.prototype.create(a,this))})};s.prototype={options:{cancel:null,disabled:false,elasticConstant:0.25,friction:0.96,section:null},canceled:false,noPadding:false,layoutStyles:["background-color","background-repeat","background-attachment",
