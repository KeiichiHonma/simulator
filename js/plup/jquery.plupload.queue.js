            ...
            this.each(function () {
                ...
                function g() {
                    ...
                    c.each(j.files, function (p, o) {
                        ...
                        //m.append('<li id="' + o.id + '"><div class="plupload_file_name"><span>' + o.name + '</span></div><div class="plupload_file_action"><a href="#"></a></div><div class="plupload_file_status">' + o.percent + '%</div><div class="plupload_clearer">&nbsp;</div>' + l + "</li>");
                        m.append('<li id="' + o.id + '"><div class="plupload_file_name"><span id="fileName' + o.id + '">'+o.name+'</span></div><div class="plupload_file_action"><a class="status" href="#"></a></div><div class="plupload_file_status">' + o.percent + '%</div><div class="plupload_clearer">&nbsp;</div><p id="testtest">123<p>' + l + "</li>");
                        h(o);
