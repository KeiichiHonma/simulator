...
(function($, window, Math, undefined) {
    ...
    $.fn.<?php echo $head; ?>flickable = <?php echo $head; ?>flickable = function(options) {
        if (typeof options === "string") { // method call
            ...
            return this.each(function() {
                ...
                if (instance) {
                    ...
                    $.data(this, 'flickable', new <?php echo $head; ?>flickable.prototype.create(options, this));
                }
            });
        }
    };

    <?php echo $head; ?>flickable.prototype = {
        options: {
            cancel: null,
            disabled: false,
            ...
            if (!this.container) {
                ...
                $.each(this.layoutStyles, function(i, proper) {
                    ...
                    if (proper === 'background-color') {
                        self.wrapper.css(proper, $.inArray(style, ['transparent', 'rgba(0, 0, 0, 0)']) >= 0 ? '#000' : style);
        ...
        flick: function() {
            ...
            if (this.sections) {
                ...
                if (this.isScrolling()) {
                    ...
                    select_id = index + 1;
                    select_a = $('#<?php echo $head; ?>select'+select_id);
    ...
    <?php echo $head; ?>flickable.prototype.create.prototype = <?php echo $head; ?>flickable.prototype;
