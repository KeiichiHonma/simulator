            ...
            <div class="boxTemp width100 cf">
                ...
                <div class="paypal-left">
                    ...
                    <div class="paypal_btn">
                        ...
                        <input type="hidden" name="return" value="http://www.simulator.813.co.jp/paypal/success?uid={$uid}">
                        <input type="hidden" name="notify_url" value="http://www.simulator.813.co.jp/paypal/notify?uid={$uid}">
