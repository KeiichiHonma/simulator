...
{*                        <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        ...
                        <input type="hidden" name="return" value="http://www.simulator.813.co.jp/paypal/success">
                        <input type="hidden" name="notify_url" value="http://www.simulator.813.co.jp/paypal/notify">
                        <img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
                        </form>*}
                        <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <input type="hidden" name="cmd" value="_s-xclick">
                        <input type="hidden" name="hosted_button_id" value="NKVFJF82EL7J8">
                        <input type="image" src="https://www.paypalobjects.com/en_US/JP/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
                        <input type="hidden" name="return" value="http://www.popapp-simulator.com/paypal/success">
                        <input type="hidden" name="notify_url" value="http://www.popapp-simulator.com/paypal/notify">
