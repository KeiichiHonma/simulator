<?php /* Smarty version 2.6.18, created on 2012-12-22 16:37:16
         compiled from paypal/basic.tpl */ ?>
<!DOCTYPE html>
            ...
            <div class="boxTemp width100 cf">
                ...
                <div class="paypal-left">
                    ...
                    <div class="paypal_btn">
                        ...
                        <input type="hidden" name="hosted_button_id" value="GFUCMRKF94TTY">
                        ...
                        <input type="hidden" name="return" value="http://www.popapp-simulator.com/paypal/success?uid=<?php echo $this->_tpl_vars['uid']; ?>
">
                        <input type="hidden" name="notify_url" value="http://www.popapp-simulator.com/paypal/notify?uid=<?php echo $this->_tpl_vars['uid']; ?>
">
